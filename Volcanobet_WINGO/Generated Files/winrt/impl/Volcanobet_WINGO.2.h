...
#pragma once
#ifndef WINRT_Volcanobet_WINGO_2_H
#define WINRT_Volcanobet_WINGO_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/Volcanobet_WINGO.1.h"
WINRT_EXPORT namespace winrt::Volcanobet_WINGO
{
    struct __declspec(empty_bases) MainWindow : winrt::Volcanobet_WINGO::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Volcanobet_WINGO::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
