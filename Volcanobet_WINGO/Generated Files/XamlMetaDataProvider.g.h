...
#include "winrt/Volcanobet_WINGO.h"
namespace winrt::Volcanobet_WINGO::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, Volcanobet_WINGO::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = Volcanobet_WINGO::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"Volcanobet_WINGO.XamlMetaDataProvider";
        }
    };
}
namespace winrt::Volcanobet_WINGO::factory_implementation
{
    ...
    {
        using instance_type = Volcanobet_WINGO::XamlMetaDataProvider;
