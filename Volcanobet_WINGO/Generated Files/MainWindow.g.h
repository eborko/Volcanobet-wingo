...
namespace winrt::Volcanobet_WINGO::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, Volcanobet_WINGO::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = Volcanobet_WINGO::MainWindow;
        ...
        {
            return L"Volcanobet_WINGO.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::Volcanobet_WINGO::factory_implementation
{
    ...
    {
        using instance_type = Volcanobet_WINGO::MainWindow;
