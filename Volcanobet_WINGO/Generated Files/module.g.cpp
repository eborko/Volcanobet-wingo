...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"Volcanobet_WINGO.MainWindow"))
    {
        return winrt_make_Volcanobet_WINGO_MainWindow();
    }

    if (requal(name, L"Volcanobet_WINGO.XamlMetaDataProvider"))
    {
        return winrt_make_Volcanobet_WINGO_XamlMetaDataProvider();
    }
