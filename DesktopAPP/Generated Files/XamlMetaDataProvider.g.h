...
#pragma once
#include "winrt/DesktopAPP.h"
#include "winrt/Microsoft.UI.Xaml.Markup.h"
namespace winrt::DesktopAPP::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, DesktopAPP::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = DesktopAPP::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"DesktopAPP.XamlMetaDataProvider";
        }
    };
}
namespace winrt::DesktopAPP::factory_implementation
{
    ...
    {
        using instance_type = DesktopAPP::XamlMetaDataProvider;
