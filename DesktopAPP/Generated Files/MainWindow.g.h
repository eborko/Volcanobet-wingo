...
namespace winrt::DesktopAPP::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, DesktopAPP::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = DesktopAPP::MainWindow;
        ...
        {
            return L"DesktopAPP.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::DesktopAPP::factory_implementation
{
    ...
    {
        using instance_type = DesktopAPP::MainWindow;
