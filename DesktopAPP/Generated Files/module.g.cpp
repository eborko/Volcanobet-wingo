...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"DesktopAPP.MainWindow"))
    {
        return winrt_make_DesktopAPP_MainWindow();
    }

    if (requal(name, L"DesktopAPP.XamlMetaDataProvider"))
    {
        return winrt_make_DesktopAPP_XamlMetaDataProvider();
    }
