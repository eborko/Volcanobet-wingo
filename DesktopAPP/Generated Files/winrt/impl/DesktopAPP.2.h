...
#pragma once
#ifndef WINRT_DesktopAPP_2_H
#define WINRT_DesktopAPP_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/DesktopAPP.1.h"
WINRT_EXPORT namespace winrt::DesktopAPP
{
    struct __declspec(empty_bases) MainWindow : winrt::DesktopAPP::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::DesktopAPP::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
